...
function LeftBox() {
	const { profilePicture, firstName, lastName, phone, email, location, birthday }: PersonalInfo = usePersonalInfo();

	return (
	  <Box className="personal-info-box" p={4} boxShadow="lg" borderRadius="md">
		{/* Profile Picture */}
		...
		{/* Name */}
		<Text className="name" fontSize="2xl" fontWeight="bold" textAlign="center" mb={4}>
		  {firstName} {lastName}
		</Text>
		...
		<Box className="info-card" p={4} bg="gray.100" _dark={{ bg: "gray.700" }} borderRadius="md">
